...
public interface PermissionServiceInterface extends Remote {
	 ...
	 * 
	 * @return Retorna uma lista com todos os Usuários existentes.
	 * 
	 ...
	 * 
	 * @return Retorna uma lista de todas as funcionalidades.
	 * 
	 * @throws ServiceException
	 *             Exceção que pode ser levantada pelo servidor em caso de problemas
	 *             na execução da tarefa.
	...
	/**
	 * Método que busca Funcionalidades a partir do Plugin as quais são
	 * pertencentes.
	 * 
	 * @param idPlugin
	 *            ID do Plugin
	 * @return Retorna uma lista de Funcionalidades pertencentes a determinado
	 *         Plugin.
	 * 
	 * @throws ServiceException
	 *             Exceção que pode ser levantada pelo servidor em caso de problemas
	 ...
	 * 
	 * @return Retorna uma lista contendo todos os Plugins existentes.
	 * 
	 * @throws ServiceException
	 * @throws RemoteException
	 */
	 ...
	 * @param idPlugin
	 *            ID do Plugin
	 * @return Retorna um objeto Plugin.
	 * 
	 * @throws ServiceException
	 *             Exceção que pode ser levantada pelo servidor em caso de problemas
	 *             na execução da tarefa.
	...
	/**
	 * Método que faz a busca de todas as Funcionalidades que determinado Usuário
	 * não possui Permissão.
	 * 
	 * @param userId
	 *            ID do usuário
	 * @return Retorna uma lista de funcionalidades as quais o usuário não possui
	 *         permissão.
	 * 
	 * @throws ServiceException
	 *             Exceção que pode ser levantada pelo servidor em caso de problemas
	 ...
	 * @return Retorna uma lista de funcionalidades permitidas para o usuário
	 *         declarado.
	 * 
	 * @throws ServiceException
	 *             Exceção que pode ser levantada pelo servidor em caso de problemas
	...
	/**
	 * Método que faz a busca pelo nome de Funcionalidades as quais determinado
	...
	/**
	 * Método que remove a Permissão de um Usuário referente a uma Funcionalidade
	 * específica.
	 * 
	 * @param Featureid
	 *            ID da funcionalidade
	...
	/**
	 * Método que verifica se determinado Usuário já possui Permissão em relação a
	 ...
	 * @param featureId
	 *            ID da funcionalidade
	 * @return Retorna um boolean indicando a existência (ou não) da permissão de
	 *         uma funcionalidade para um usuário específico
	 * 
	 * @throws ServiceException
	 *             Exceção que pode ser levantada pelo servidor em caso de problemas
	 *             na execução da tarefa.
	...
	/**
	 * Método que salva a Permissão de um Usuário referente a uma Funcionalidade
	 * específica.
	 * 
	 * @param userId
	 *            ID do usuário
